        ...
        <div className="rounded-2xl border bg-card p-8 space-y-6">
          <div className="space-y-4 text-center">
            ...
            <button
              ...
              disabled={loading}
              className="inline-flex w-full items-center justify-center gap-3 rounded-xl bg-[#5865F2] px-6 py-3 font-semibold text-white transition-colors hover:bg-[#4752C4] disabled:opacity-50"
            >
